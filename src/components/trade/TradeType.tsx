    ...
    >
      {links.map((link, i) => (
        <Link
          ...
          className="rounded-md hover:surface flex items-center justify-center gap-8 py-8 px-16 text-white/60 aria-[current=page]:bg-black aria-[current=page]:text-white"
        >
          {link.svg}
          {link.label}
