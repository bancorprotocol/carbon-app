...
export const WalletConnect = () => {
  return (
    <section
      ...
      className="bg-black justify-self-stretch rounded-lg border-main-800 flex flex-1 flex-col justify-evenly gap-32 border px-32 py-24 md:mt-32 md:flex-row md:items-center"
    >
