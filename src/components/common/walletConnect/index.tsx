...
export const WalletConnect = () => {
  return (
    <section
      ...
      className="flex flex-1 flex-col justify-evenly gap-32 rounded-10 border border-background-800 py-24 px-32 md:mt-32 md:flex-row md:items-center"
    >
      ...
      <hr className="border-t border-background-800 md:h-[300px] md:border-r" />
