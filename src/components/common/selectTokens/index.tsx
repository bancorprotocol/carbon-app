...
export const SelectTokens: FC<Props> = ({
  ...
  return (
    <div className="flex items-center justify-between">
      <button
        onClick={() => onClick0()}
        className="-mr-13 rounded-xl px-18 flex w-[140px] grow items-center bg-black-gradient py-10"
      >
      ...
      <button
        onClick={() => onClick1()}
        className="-ml-13 rounded-xl px-18 flex w-[140px] grow items-center bg-black-gradient py-10"
      >
        <LogoImager
          alt=""
          src={imgUrl1}
