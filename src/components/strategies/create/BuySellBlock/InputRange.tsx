  ...
  return (
    <>
      <div className="grid grid-cols-2 gap-6">
        <div
          className={`
            rounded-r-4 rounded-l-16 w-full cursor-text border border-black bg-black p-16
        ...
        <div
          className={`
            rounded-r-16 rounded-l-4 w-full cursor-text border border-black bg-black p-16
            focus-within:border-white/50
            ${error ? '!border-error/50' : ''}
            ${showWarning ? '!border-warning' : ''}
          `}
