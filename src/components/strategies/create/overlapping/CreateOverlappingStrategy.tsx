...
export const CreateOverlappingStrategy: FC<OverlappingStrategyProps> = (
  ...
  return (
    <>
      <article className="grid grid-flow-col grid-cols-[auto_auto] grid-rows-2 gap-8 rounded-10 bg-background-800 p-20">
      ...
      <article className="flex flex-col gap-20 rounded-10 bg-background-800 p-20">
      ...
      <article className="flex flex-col gap-10 rounded-10 bg-background-800 p-20">
