...
export const BudgetWarning: FC<Props> = ({ base, quote, state, setState }) => {
  ...
  return (
    <article className="border-warning-500 flex w-full flex-col gap-16 rounded-10 border bg-background-900 p-20">
      <header className="flex items-center gap-8 ">
        <IconWarning className="text-warning-500 h-14 w-14" />
