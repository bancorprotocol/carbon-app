      ...
      {!minAboveMarket && !maxBelowMarket && (
        <p className="text-12 text-white/60">
          ...
          <a
            ...
            target="_blank"
            className="text-green inline-flex items-center gap-4 text-12 font-weight-500"
            rel="noreferrer"
          >
            Learn More
  ...
  if (change.gt(0)) {
    return (
      <div className="flex items-center gap-8">
        <IconArrowDown className="text-green h-16 w-16 rotate-180" />
    ...
    return (
      <div className="flex items-center gap-8">
        <IconArrowDown className="text-red h-16 w-16" />
        <p className="text-12 font-weight-400 text-white/60">
          You will withdraw&nbsp;
