  ...
  return (
    <>
      <div className="grid grid-cols-2 gap-6">
        <div
          className="rounded-s-2xl grid w-full cursor-text gap-4 border border-black bg-black-gradient p-16 focus-within:border-white/50"
        ...
        <div
          className="rounded-e-2xl grid w-full cursor-text gap-4 border border-black bg-black-gradient p-16 focus-within:border-white/50"
