...
const IndicatorTooltip: FC<TooltipProps> = (props) => {
  ...
  return (
    <FloatTooltip>
      ...
      <FloatTooltipContent className="bg-background-800 text-12 font-medium flex max-h-[300px] flex-col items-center gap-8 overflow-auto rounded-16 p-16 text-white/80">
