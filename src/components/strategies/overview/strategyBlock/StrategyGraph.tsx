...
const StaticOrderTooltip: FC<OrderTooltipProps<StaticOrder>> = ({
  ...
  return (
    ...
    >
      ...
      {limit && (
        <table className="bg-black-gradient rounded-md border-separate border border-white/40">
          <tbody>
            <tr>
      ...
      {!limit && (
        <table className="bg-black-gradient rounded-md border-separate border border-white/40 p-8">
          <tbody>
            <tr>
