...
describe('Test helpers', () => {
  ...
  describe('prettifyNumber', () => {
    ...
    test('should return "< $0.01" for input 0.001 and currentCurrency is USD', () => {
      expect(prettifyNumber(0.001, { currentCurrency: 'USD' })).toEqual(
        '< $0.01'
      );
    });

    test('should return "< €0.01" for input 0.001 and currentCurrency is EUR', () => {
      expect(prettifyNumber(0.001, { currentCurrency: 'EUR' })).toEqual(
        '< €0.01'
      );
    });

    test('should return "< 0.01 ETH" for input 0.001 and currentCurrency is ETH', () => {
      expect(prettifyNumber(0.001, { currentCurrency: 'ETH' })).toEqual(
        '< 0.01 ETH'
      );
    });

    test('should return "< ¥0.01" for input 0.001 and currentCurrency is JPY', () => {
    ...
    test('should return "< 0.000001" for input 0.0000001 and no currentCurrency selected', () => {
