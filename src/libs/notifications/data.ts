...
export const NOTIFICATIONS_MAP: NotificationsMap = {
  ...
  approveError: ({ symbol }) => ({
    ...
    description:
      i18n.t('notifications.descriptions.description10', {
        token: symbol,
      }) || '',
    showAlert: true,
  }),
  ...
  trade: ({ amount, txHash, to, from }) => ({
    ...
    description:
      i18n.t('notifications.descriptions.description35', {
        amount,
        from,
        to,
      }) || '',
    ...
    successDesc:
      i18n.t('notifications.descriptions.description36', {
        amount,
        from,
        to,
      }) || '',
    ...
    failedDesc:
      i18n.t('notifications.descriptions.description37', {
        amount,
        from,
        to,
      }) || '',
