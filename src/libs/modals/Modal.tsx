  ...
  return (
    ...
    >
      ...
      >
        <div
          data-testid={testId}
          className="rounded-lg bg-new-primary/60 backdrop-blur-xs glass-shadow relative flex w-full flex-col gap-20 overflow-hidden border-0 p-20 outline-hidden focus:outline-hidden"
        >
          {isPending && (
