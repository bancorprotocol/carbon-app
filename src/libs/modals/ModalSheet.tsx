  ...
  return (
    <Overlay close={() => onCloseHandler(id)} className="items-end">
      <m.div
        ...
        exit="exit"
      >
        <div className="bg-white-gradient backdrop-blur-xs rounded-t-md relative flex w-full flex-col gap-20 overflow-hidden border-0 p-20 outline-hidden focus:outline-hidden">
          {isPending && (
