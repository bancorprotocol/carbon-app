      ...
      <form className="grid gap-16 overflow-auto" onSubmit={submit}>
        ...
        >
          ...
          <div className="overflow-auto rounded-2xl">
            ...
            >
              <thead>
                <tr>
                  <th className="sticky top-0 p-8 bg-main-900">
                    <Checkbox
                      className="m-auto"
                  ...
                  <th className="text-14 font-medium sticky top-0 py-8 text-main-0/60 bg-main-900">
                    {source.symbol}
                  </th>
        ...
        >
          ...
          <TokenInputField
            ...
            className="rounded-xl -mt-16 p-16 input-container"
          />
        </div>
