...
const buttonClasses =
  'flex h-44 w-full items-center space-x-16 rounded-md px-10 hover:bg-black-gradient disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-transparent';
