  ...
  return (
    <>
      ...
      <p>
        ...
        AVAILABLE AT{' '}
        <a
          href="https://www.carbondefi.xyz/terms"
          target={'_blank'}
          rel="noreferrer"
        ...
        (THE “TERMS OF USE”), AND BY ACCEPTING SUCH TERMS OF USE PURSUANT TO THE
        TERMS THEREIN OR BY USING THE SITE, YOU ALSO HEREBY AGREE TO ACCEPT THE
        TERMS OF THIS PRIVACY POLICY IN ALL RESPECTS.
      </p>
      <p>
        IF YOU DO NOT AGREE WITH THE TERMS OF USE OR THIS PRIVACY POLICY, DO NOT
      ...
      <p className="mt-40">
        ...
        “User” and collectively with others using the Site, the “Users”, and
        “you” or “your” as used herein refers to you as the User) agree to be
        bound by this privacy policy (this “Privacy Policy”). The rights in the
        ...
        and “our” refer to the Foundation. Please read this Privacy Policy
        carefully. This Privacy Policy, together with the Terms of Use, govern
        your access to and use of the Site and Content (as defined in the Terms
        of Use).
      </p>
